...
function init_gear_sets()
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {ear1="Thrud Earring",head="Agoge Mask +4",body="Pumm. Lorica +4",hands="Boii Mufflers +2",waist="Sailfi Belt +1",feet="Sulev. Leggings +2"})
