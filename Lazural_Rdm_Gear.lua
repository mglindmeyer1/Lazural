function user_job_setup()
	...
	state.Weapons:options('None','Naegling','DT','DualWeapons','DualWeaponsAcc','DualEvisceration','DualClubs','DualAeolian','DualProcDaggers','EnspellOnly','EnspellDW')
...
function init_gear_sets()
	...
	sets.precast.FC = {main="Mpaca's Staff",sub="Clerisy Strap",range=empty,ammo="Impatiens",
		...
		body="Vitiation Tabard",hands="Gendewitha Gages",ring1="Kishar Ring",ring2="Lebeche Ring",
	...
	sets.precast.WS = {range=empty,ammo="Voluspa Tathlum",
		...
		back=gear.wsd_jse_back,waist="Windbuffet Belt",legs="Carmine Cuisses +1",feet="Carmine Greaves"}
	...
	sets.precast.WS['Savage Blade'] = {range=empty,ammo="Focal Orb",
		head="Jhakri Coronal +2",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",
		body="Ayanmo Corazza +2",hands="Jhakri Cuffs +2",ring1="Ifrit Ring",ring2="Rufescent Ring",
	...
	sets.midcast.FastRecast = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap",range=empty,ammo="Hasty Pinion +1",
		head="Atro. Chapeau +1",neck="Voltsurge Torque",ear1="Malignance Earring",ear2="Lethargy Earring",
		body="Shango Robe",hands="Gendewitha Gages",ring1="Kishar Ring",ring2="Prolix Ring",
	...
	sets.midcast['Enhancing Magic'] = {main="Colada",sub="Ammurapi Shield",range=empty,ammo="Hasty Pinion +1",
		head="Telchine Cap",neck="Dls. Torque",ear1="Andoaa Earring",ear2="Lethargy Earring",
		body="Viti. Tabard",hands="Atrophy Gloves +1",ring1="Stikini Ring",ring2="Stikini Ring",
	...
	sets.buff.ComposureOther = {head="Leth. Chappel",
		...
		legs="Leth. Fuseau",feet="Leth. Houseaux +1"}
		
	--Red Mage enhancing sets are handled in a different way from most, layered on due to the way Composure works
	--Don't set combine a full set with these spells, they should layer on Enhancing Set > Composure (If Applicable) > Spell
	sets.EnhancingSkill = {main="Pukulatmuj +1",head="Befouled Crown",neck="Incanter's Torque",ear2="Lethargy Earring",hands="Viti. Gloves +3",back="Ghostfyre Cape",waist="Olympus Sash",legs="Atrophy Tights +3"}
	...
	sets.midcast['Enfeebling Magic'] = {main="Daybreak",sub="Ammurapi Shield",range=empty,ammo="Regal Gem",
		head="Viti. Chapeau +1",neck="Dls. Torque +1",ear1="Malignance Earring",ear2="Snotra Earring",
		body="Lethargy Sayon",hands="Bunzi's Gloves",ring1="Kishar Ring",ring2="Stikini Ring",
		back=gear.nuke_jse_back,waist="Luminary Sash",legs="Chironic Hose",feet="Bunzi's Sabots"}
	...
	sets.midcast.DurationOnlyEnfeebling = set_combine(sets.midcast['Enfeebling Magic'], {main="Bunzi's Rod",body="Atrophy Tabard",range="Kaja Bow"})
    ...
    sets.midcast['Elemental Magic'] = {main="Bunzi's Rod",sub="Ammurapi Shield",range=empty,ammo="Ghastly Tathlum +1",
        ...
        body="Bunzi's Robe",hands="Bunzi's Gloves",ring1="Shiva Ring +1",ring2="Metamorph Ring +1",
        back=gear.nuke_jse_back,waist=gear.ElementalObi,legs="Bunzi's Pants",feet="Bunzi's Sabots"}
    ...
    sets.midcast['Elemental Magic'].Proc = {main=empty,sub=empty,range=empty,ammo="Impatiens",
        head="Vanya Hood",neck="Voltsurge Torque",ear1="Loquac. Earring",ear2="Lethargy Earring",
	...
	sets.midcast.Impact = {main="Bunzi's Rod",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		head=empty,neck="Erra Pendant",ear1="Malignance Earring",ear2="Lethargy Earring",
	...
	sets.midcast['Dark Magic'] = {main="Rubicundity",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		head="Amalric Coif",neck="Erra Pendant",ear1="Malignance Earring",ear2="Lethargy Earring",
    ...
    sets.midcast.Drain = {main="Rubicundity",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
        head="Pixie Hairpin +1",neck="Erra Pendant",ear1="Malignance Earring",ear2="Lethargy Earring",
	...
	sets.midcast.Stun = {main="Bunzi's Rod",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		head="Atrophy Chapeau +3",neck="Dls. Torque +1",ear1="Malignance Earring",ear2="Lethargy Earring",
	...
	sets.idle = {main="Mpaca's Staff",sub="Mensch Strap",range=empty,ammo="Homiliary",
		head="Viti. Chapeau +1",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Jhakri Robe +2",hands=gear.chiron_hands_REF,ring1="Defending Ring",ring2="Sangoma Ring",
	...
	sets.idle.Weak = {main="Mpaca's Staff",sub="Mensch Strap",range=empty,ammo="Homiliary",
		head="Viti. Chapeau +1",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Etheral Earring",
		body="Bunzi's Robe",hands="Bunzi's Gloves",ring1="Defending Ring",ring2="Dark Ring",
		back="Moonbeam Cape",waist="Flume Belt",legs="Bunzi's Pants",feet="Bunzi's Sabots"}
...
--		back=gear.stp_jse_back,waist="Windbuffet Belt +1",legs="Carmine Cuisses +1",feet="Carmine Greaves +1"}
	...
	sets.engaged.DW = {ammo="Coiste Bodhar",
		head="Aya. Zucchetto +2",neck="Anu Torque",ear1="Suppanomimi",ear2="Sherida Earring",
		body="Ayanmo Corazza +2",hands="Bunzi's Gloves",ring1="Petrov Ring",ring2="Chirich Ring",
