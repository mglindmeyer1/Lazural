function user_job_setup()
	...
	state.Weapons:options('Savage','Chango','Greatsword','DualWeapons','Club','Axe','Polearm','None','ProcDagger','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana','ProcKatana','ProcClub','ProcStaff')
...
function init_gear_sets()
	...
	sets.precast.JA['Berserk'] = {back="Cichol's Mantle",body="Pumm. Lorica +4",feet="Agoge Calligae +1"}
	...
	sets.precast.FC = {ammo="Impatiens",
		...
		back="Moonbeam Cape",waist="Flume Belt +1",legs="Eschite Cuisses",feet="Odyssean Greaves"}
	...
	sets.Cure_Received = {Head="Souv. Schaller +1",body="Sakpata's Plate",ring2="Kunaji Ring",waist="Gishdubar Sash",legs="Souv. Diechlings +1",feet="Souveran schuhs +1"}
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {ear1="Thrud Earring",head="Agoge Mask +4",body="Pumm. Lorica +4",hands="Boii Mufflers +2",ring1="Epaminondas's Ring",waist="Sailfi Belt +1",feet="Sulev. Leggings +2"})
	...
	sets.precast.WS['Judgement'] = set_combine(sets.precast.WS, {ear1="Thrud Earring",head="Agoge Mask +4",body="Pumm. Lorica +4",hands="Boii Mufflers +2",ring1="Epaminondas's Ring",waist="Sailfi Belt +1",feet="Sulev. Leggings +2"})
    sets.precast.WS['Judgement'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {})
    sets.precast.WS['Judgement'].Acc = set_combine(sets.precast.WS.Acc, {})
    sets.precast.WS['Judgement'].FullAcc = set_combine(sets.precast.WS.FullAcc, {})
	...
	sets.precast.WS["Impulse Drive"] = set_combine(sets.precast.WS, {ear1="Thrud Earring",head="Agoge Mask +4",body="Pumm. Lorica +4",hands="Boii Mufflers +2",ring1="Epaminondas's Ring",waist="Sailfi Belt +1",feet="Sulev. Leggings +2"})
	...
	sets.precast.WS["Cloudsplitter"] = set_combine(sets.precast.WS, {ear1="Thrud Earring",head="Agoge Mask +4",neck="Sanctity Necklace",body="Pumm. Lorica +4",hands="Boii Mufflers +2",ring1="Epaminondas's Ring",ring2="Acumen Ring",waist="Skymir Cord",feet="Sulev. Leggings +2"})
	...
	sets.idle = {ammo="Staunch Tathlum",
		head="Hjarrandi Helm",neck="Loricate Torque +1",ear1="Tuisto Earring",ear2="Ethereal Earring",
		body="Hjarrandi Breast.",hands="Sakpata's Gauntlets",ring1="Moonlight Ring",ring2="Shneddick Ring",
	...
	sets.engaged = {ammo="Coiste Bodhar",
		head="Flam. Zucchetto +2",neck="War. Beads +1",ear1="Schere Earring",ear2="Boii Earring",
	...
	sets.engaged['Chango'] = {ammo="Aurgelmir Orb",
		head="Flam. Zucchetto +2",neck="War. Beads +1",ear1="Dedition Earring",ear2="Schere Earring",
		body="Boii Lorica +2",hands="Sakpata's Gauntlets",ring1="Moonlight Ring",ring2="Niqmaddu Ring",
		back=gear.da_jse_back,waist="Ioskeha Belt +1",legs="Pumm. Cuisses +2",feet="Flam. Gambieras +2"}
	
    
	sets.engaged['Chango'].Hybrid = set_combine(sets.engaged,{head="Hjarrandi Helm",body="Hjarrandi Breast.",ear1="Dedition Earring"})

	sets.engaged['Chango'].PDT = set_combine(sets.engaged,{head="Hjarrandi Helm",body="Sakpata's Plate",ear1="Dedition Earring",hands="Sakpata's Gauntlets",legs="Sakpata's Cuisses",feet="Sakpata's Leggings" })
	
	sets.engaged['Chango'].Reraise = set_combine(sets.engaged,{neck="Loricate Torque +1",head="Twilight Helm",body="Twilight Mail",Ring1="Defending Ring",Ring2="Moonlight Ring",ear1="Dedition Earring"}) 
	...
	sets.engaged['Greatsword'].Hybrid = set_combine(sets.engaged,{head="Hjarrandi Helm",body="Hjarrandi Breast.",ear1="Dedition Earring"})

	sets.engaged['Greatsword'].PDT = set_combine(sets.engaged,{head="Hjarrandi Helm",body="Sakpata's Plate",ear1="Dedition Earring",hands="Sakpata's Gauntlets",legs="Sakpata's Cuisses",feet="Sakpata's Leggings" })
	
	sets.engaged['Greatsword'].Reraise = set_combine(sets.engaged,{neck="Loricate Torque +1",head="Twilight Helm",body="Twilight Mail",Ring1="Defending Ring",Ring2="Moonlight Ring",ear1="Dedition Earring"}) 
	
	sets.engaged['DualWeapons'] = {ammo="Aurgelmir Orb",
		head="Flam. Zucchetto +2",neck="War. Beads +1",ear1="Eabani earring",ear2="Suppanomimi",
		body="Boii Lorica +2",hands="Sakpata's Gauntlets",ring1="Moonlight Ring",ring2="Niqmaddu Ring",
	...
	sets.engaged.Acc = {ammo="Aurgelmir Orb",
		head="Flam. Zucchetto +2",neck="War. Beads +1",ear1="Digni. Earring",ear2="Telos Earring",
    ...
    sets.engaged.FullAcc = {ammo="Aurgelmir Orb",
		head="Flam. Zucchetto +2",neck="War. Beads +1",ear1="Mache Earring +1",ear2="Telos Earring",
    ...
    sets.engaged.Fodder = {ammo="Aurgelmir Orb",
		head="Flam. Zucchetto +2",neck="War. Beads +1",ear1="Brutal Earring",ear2="Cessance Earring",
	...
	sets.weapons.Axe = {main="Kaja Axe",sub="Blurred Shield +1"}
