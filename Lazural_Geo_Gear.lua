function user_job_setup()
	...
	gear.idle_jse_back = "Lifestream Cape"
...
function init_gear_sets()
	...
	sets.precast.FC = {main="Solstice",sub="Culminus",ammo="Impatiens",
		...
		body="Shango Robe",hands="Bagua Mittens",ring1="Kishar Ring",ring2="Lebeche Ring",
	...
	sets.midcast.Geomancy = {main="Solstice",sub="Culminus",range="Dunna",
		head="Telchine Cap",neck="Bagua Charm +1",ear1="Gifted Earring",ear2="Malignance Earring",
		body="Amalric Doublet",hands="Geomancy Mitaines",ring1="Defending Ring",ring2="Gelatinous Ring +1",
		back="Solemnity Cape",waist="Austerity Belt",legs="Geo. Pants +1",feet="Medium's Sabots"}
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Grioavolr",sub="Enki Strap",ammo="Pemphredo Tathlum",
        ...
        body="Jhakri Robe +2",hands="Amalric Gages",ring1="Shiva Ring",ring2="Acumen Ring",
        back=gear.nuke_jse_back,waist="Eschan Stone",legs="Merlinic Shalwar",feet=gear.Merlinic_feet_MAB}
    ...
    sets.midcast['Elemental Magic'].HighTierNuke = {main="Daybreak",sub="Culminus",ammo="Pemphredo Tathlum",
        head="Merlinic Hood",neck="Baetyl Pendant",ear1="Barkaro. Earring",ear2="Malignance Earring",
        body="Jhakri Robe +2",hands="Amalric Gages",ring1="Shiva Ring",ring2="Acumen Ring",
        back=gear.nuke_jse_back,waist=gear.ElementalObi,legs="Merlinic Shalwar",feet=gear.Merlinic_feet_MAB}
    ...
    sets.midcast.Drain = {main="Rubicundity",sub="Culminus",ammo="Pemphredo Tathlum",
        ...
        body="Shango Robe",hands="Amalric Gages",ring1="Archon Ring",ring2="Evanescence Ring",
        back=gear.nuke_jse_back,waist="Fucho-no-obi",legs="Merlinic Shalwar",feet=gear.Merlinic_feet_MAB}
	...
	sets.midcast.Stun = {main="Grioavolr",sub="Clerisy Strap",ammo="Hasty Pinion +1",
		...
		body="Shango Robe",hands="Volte Gloves",ring1="Metamor. Ring +1",ring2="Stikini Ring",
	...
	sets.midcast.Stun.Resistant = {main="Daybreak",sub="Culminus",ammo="Pemphredo Tathlum",
		...
		back=gear.nuke_jse_back,waist="Acuity Belt +1",legs="Merlinic Shalwar",ffeet=gear.Merlinic_feet_MAB}
	...
	sets.midcast.Impact = {main="Daybreak",sub="Culminus",ammo="Pemphredo Tathlum",
		...
		back=gear.nuke_jse_back,waist="Acuity Belt +1",legs="Merlinic Shalwar",feet=gear.Merlinic_feet_MAB}
	...
	sets.midcast['Enfeebling Magic'] = {main="Grioavolr",sub="Enki Strap",ammo="Pemphredo Tathlum",
		...
		body="Shango Robe",hands="Azimuth Gloves",ring1="Kishar Ring",ring2="Stikini Ring",
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Grioavolr",sub="Enki Strap",ammo="Pemphredo Tathlum",
		head="Befouled Crown",neck="Erra Pendant",ear1="Regal Earring",ear2="Digni. Earring",
		body="Shango Robe",hands="Azimuth Gloves",ring1="Metamor. Ring +1",ring2="Stikini Ring",
	...
	sets.idle = {main="Daybreak",sub="Culminus",ammo="Staunch Tathlum",
		head="Befouled Crown",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Jhakri Robe +2",hands="Bagua Mitaines",ring1="Defending Ring",ring2="Mephitas's Ring",
		back="Shadow Mantle",waist="Carrier's Sash",legs="Assid. Pants +1",feet=gear.merlinic_refresh_feet}
	...
	sets.idle.Pet = {main="Solstice",sub="Culminus",range="Dunna",
		head="Azimuth Hood",neck="Bagua Charm +1",ear1="Handler's Earring",ear2="Handler's Earring +1",
		body="Jhakri Robe +2",hands="Geomancy Mitaines",ring1="Defending Ring",ring2="Dark Ring",
	...
	sets.idle.PDT.Pet = {main="Malignance Pole",sub="Umbra Strap",range="Dunna",
		head="Azimuth Hood",neck="Bagua Charm +1",ear1="Handler's Earring",ear2="Handler's Earring +1",
		body="Jhakri Robe +2",hands="Geomancy Mitaines",ring1="Defending Ring",ring2="Dark Ring",
		back=gear.idle_jse_back,waist="Isa Belt",legs="Nyame Flanchard",feet="Bagua Sandals"}
	...
	sets.defense.PDT = {main="Malignance Pole",sub="Umbra Strap",ammo="Staunch Tathlum +1",
		...
		back="Umbra Cape",waist="Carrier's Sash",legs="Nyame Flanchard",feet="Azimuth Gaiters"}
