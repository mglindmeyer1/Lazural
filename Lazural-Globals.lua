...
send_command('bind @m gs c mount Spectral Chair')
send_command('bind ^h gs c useitem ring2 Warp Ring')
send_command('bind !h gs c useitem ring2 Dim. Ring (Holla)')
send_command('bind !s input /con tt si')
send_command('bind PageDown input /con send @others c4 Lazural')
send_command('bind PageUp input /con send @others curaga 3 Lazural')
send_command('bind !PageDown input /con stna')
send_command('bind !End input /con send @others erase Lazural')
send_command('bind ^End input /con send @others cure 4 <tid>')
send_command('bind ^!End input /con send @others exec Pro & Shell')
send_command('bind @!End input /con send @others exec Bars')
send_command('bind @^End input /con send @others exec Reraise')
send_command('bind ~End input /con send @all gs c useitem ring2 Warp Ring')
send_command('bind @End input /con send Aneybug gs c buffup')
send_command('bind @Delete input /con send Aneybug c4 Mrgamm')
