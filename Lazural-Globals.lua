...
send_command('bind PageUp input /con send Aneybug curaga 2 Lazural')
send_command('bind !PageDown input /con stna')
send_command('bind !End input /con send Aneybug erase Lazural')
send_command('bind ^End input /con send Aneybug cure 4 <stpc>')
